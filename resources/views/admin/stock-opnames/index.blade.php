...
dark:text-gray-300 dark:focus:border-indigo-700 dark:active:bg-gray-700 dark:active:text-gray-300" />
                        ...
                        <div class="sm:ml-16 sm:mt-0 sm:flex-none">
                            <a type="button" href="{{ route('stock-opnames.create') }}"
                                ...
                                @forelse($stockOpnames as $stockOpname)
                                    <tr
                                        ...
                                        <td class="px-6 py-2 text-center">
                                            {{ $stockOpname->nama_gudang }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $stockOpname->kode_item }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $stockOpname->kode_barcode }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $stockOpname->nama_item }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $stockOpname->satuan }}
                                        </td>
                                        ...
                                        <td class="px-6 py-2 text-center">
                                            {{ format_tanggal_id($stockOpname->created_at, true, true) }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $stockOpname->updated_at }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
