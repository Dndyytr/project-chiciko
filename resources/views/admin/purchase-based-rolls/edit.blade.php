<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Ubah Pembelian Berdasarkan Roll') }}
        </h2>
    </x-slot>
    <div class="py-12">
        <div class="mx-auto space-y-6">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-sm">
                <div class="mx-auto grid w-full py-4 px-4 sm:px-6 lg:px-8 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('purchase-based-rolls.update', $purchaseBasedRoll->id) }}"
                        x-data="purchaseBasedRollsForm()">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="w-full grid grid-cols-2 gap-2 lg:gap-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="kode_barcode" class="block mt-1 w-full" type="text"
                                    name="kode_barcode" x-model="$store.rollsForm.kodeBarcode" :value="old('kode_barcode', $purchaseBasedRoll->kode_barcode)"
                            ...
                            <div>
                                ...
                                <x-text-input id="nama_barang" class="block mt-1 w-full" type="text"
                                    name="nama_barang" x-model="$store.rollsForm.namaBarang" :value="old('nama_barang', $purchaseBasedRoll->nama_barang)"
                                    placeholder="Terisi Otomatis" readonly required />
                        ...
                        <div class="w-full grid grid-cols-2 gap-2 lg:gap-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="jenis_kain" class="block mt-1 w-full" type="text" name="jenis_kain"
                                    :value="old('jenis_kain', $purchaseBasedRoll->jenis_kain)" x-model="$store.rollsForm.jenisKain" placeholder="Terisi Otomatis"
                                    readonly required />
                            ...
                            <div>
                                ...
                                <x-text-input id="warna" class="block mt-1 w-full" type="text" name="warna"
                                    :value="old('warna', $purchaseBasedRoll->warna)" x-model="$store.rollsForm.warna" placeholder="Terisi Otomatis"
                                    readonly required />
                        ...
                        <div class="w-full grid grid-cols-2 gap-2 lg:gap-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="qty_roll" class="block mt-1 w-full" type="number" name="qty_roll"
                                    :value="old('qty_roll', $purchaseBasedRoll->qty_roll)" x-model.number="$store.rollsForm.qtyRoll"
                                    placeholder="Terisi Otomatis" readonly required />
                            ...
                            <div>
                                ...
                                <x-text-input id="yard_per_roll" class="block mt-1 w-full" type="number"
                                    :value="old('yard_per_roll', $purchaseBasedRoll->yard_per_roll)" name="yard_per_roll" required />
                        ...
                        <div class="grid w-full grid-cols-2 gap-2 lg:gap-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="kg_per_roll" class="block mt-1 w-full" type="number" step="0.01"
                                    :value="old('kg_per_roll', $purchaseBasedRoll->kg_per_roll)" name="kg_per_roll" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="jumlah_roll_satuan" class="block mt-1 w-full" type="number"
                                    :value="old('jumlah_roll_satuan', $purchaseBasedRoll->jumlah_roll_satuan)" name="jumlah_roll_satuan"
                                    x-model="$store.rollsForm.jumlahRollSatuan" readonly placeholder="Terisi Otomatis"
                                    required />
                        ...
                        <div class="grid w-full grid-cols-2 gap-2 lg:gap-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="total_harga" class="block mt-1 w-full" type="number" step="0.01"
                                    :value="old('total_harga', $purchaseBasedRoll->total_harga)" name="total_harga" x-model="$store.rollsForm.totalHarga" readonly
                            ...
                            <div>
                                ...
                                <x-text-input id="harga_per_satuan" class="block mt-1 w-full" type="number"
                                    :value="old('harga_per_satuan', $purchaseBasedRoll->harga_per_satuan)" step="0.01" name="harga_per_satuan"
                                    x-model="$store.rollsForm.hargaPerSatuan" readonly placeholder="Terisi Otomatis"
                                    required />
...
<script defer>
    const editData = {
        incoming_raw_materials_id: "{{ $purchaseBasedRoll->incoming_raw_materials_id }}",
        kode_barcode: "{{ $purchaseBasedRoll->kode_barcode }}",
        nama_barang: "{{ $purchaseBasedRoll->nama_barang }}",
        jenis_kain: "{{ $purchaseBasedRoll->jenis_kain }}",
        warna: "{{ $purchaseBasedRoll->warna }}",
        qty_roll: "{{ $purchaseBasedRoll->qty_roll }}",
        jumlah_roll_satuan: "{{ $purchaseBasedRoll->jumlah_roll_satuan }}",
        total_harga: "{{ $purchaseBasedRoll->total_harga }}",
        harga_per_satuan: "{{ $purchaseBasedRoll->harga_per_satuan }}",
    }

    document.addEventListener('alpine:init', () => {
        Alpine.store('rollsForm', {
            rollSelector: editData.incoming_raw_materials_id,
            kodeBarcode: editData.kode_barcode,
