                ...
                <div class="mx-auto grid w-full py-4 px-4 sm:px-6 lg:px-8 text-gray-900 dark:text-gray-100">
                    <div class="flex items-center justify-between py-5 mb-5">
                        ...
                        <div class="md:mt-0 sm:flex-none w-72">
                            <form action="{{ route('incoming-complement-materials.index') }}" method="GET">
...
dark:text-gray-300 dark:focus:border-indigo-700 dark:active:bg-gray-700 dark:active:text-gray-300" />
                        ...
                        <div class="sm:ml-16 sm:mt-0 sm:flex-none">
                            <a type="button" href="{{ route('incoming-complement-materials.create') }}"
...
dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    ...
                                    <th scope="col" class="px-6 py-3 text-center">
                                        <span>Nama Barang Sesuai Nota</span>
                                    </th>
                                    <th scope="col" class="px-6 py-3 text-center">
                                        <span>Jenis</span>
                                    </th>
                                    <th scope="col" class="px-6 py-3 text-center">
                                        <span>Jumlah SUS</span>
                                    </th>
                                    <th scope="col" class="px-6 py-3 text-center">
                                        <span>Satuan Ukur SUS</span>
                                    </th>
                                    <th scope="col" class="px-6 py-3 text-center">
                                        <span>Harga Satuan SUS</span>
                                    </th>
                                    <th scope="col" class="px-6 py-3 text-center">
                                        <span>Jumlah KSU</span>
                                    </th>
                                    <th scope="col" class="px-6 py-3 text-center">
                                        <span>Satuan Ukur KSU</span>
                                    </th>
                                    <th scope="col" class="px-6 py-3 text-center">
                                        <span>Total Nilai SI</span>
                                    </th>
                                    <th scope="col" class="px-6 py-3 text-center">
                                        <span>Satuan Ukur SI</span>
                                    </th>
                                    <th scope="col" class="px-6 py-3 text-center">
                                        <span>Harga/Satuan Ukur SI</span>
                                    </th>
                                    <th scope="col" class="px-6 py-3 text-center">
                                        <span>Sub Total</span>
                                    </th>
                            ...
                            <tbody>
                                @forelse($incomingComplementMaterials as $incomingComplementMaterial)
                                    <tr
...
text-center">
                                        ...
                                        <td class="px-6 py-2 text-center">
                                            {{ $incomingComplementMaterial->tanggal_nota }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $incomingComplementMaterial->no_kwitansi }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $incomingComplementMaterial->kode_supplier }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $incomingComplementMaterial->nama_supplier }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $incomingComplementMaterial->kode }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $incomingComplementMaterial->nama_barang_sesuai_nota }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $incomingComplementMaterial->jenis }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $incomingComplementMaterial->jumlah_sus }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $incomingComplementMaterial->satuan_ukur_sus }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $incomingComplementMaterial->harga_satuan_sus }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $incomingComplementMaterial->jumlah_ksu }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $incomingComplementMaterial->satuan_ukur_ksu }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $incomingComplementMaterial->total_nilai_si }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $incomingComplementMaterial->satuan_ukur_si }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $incomingComplementMaterial->harga_satuan_ukur_si }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $incomingComplementMaterial->sub_total }}
                                        </td>
                                        <td class="px-6 py-2 text-center">

                                            <form
                                                action="{{ route('incoming-complement-materials.destroy', $incomingComplementMaterial->id) }}"
                                                method="POST">

                                                <div class="flex">
                                                    <a href="{{ route('incoming-complement-materials.edit', $incomingComplementMaterial->id) }}"
...
dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">
                        ...
                        <div class="relative p-3">
                            {{ $incomingComplementMaterials->links() }}
                        </div>
                    </div>
                </div>
            </div>
