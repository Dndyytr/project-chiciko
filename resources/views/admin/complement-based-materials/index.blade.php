                ...
                <div class="mx-auto grid w-full py-4 px-4 sm:px-6 lg:px-8 text-gray-900 dark:text-gray-100">
                    <div class="flex items-center justify-between py-5 mb-5">
                        ...
                        <div class="md:mt-0 sm:flex-none w-72">
                            <form action="{{ route('complement-based-materials.index') }}" method="GET">
...
dark:text-gray-300 dark:focus:border-indigo-700 dark:active:bg-gray-700 dark:active:text-gray-300" />
                        ...
                        <div class="sm:ml-16 sm:mt-0 sm:flex-none">
                            <a type="button" href="{{ route('complement-based-materials.create') }}"
...
dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <tbody>
                                @forelse($complementBasedMaterials as $complementBasedMaterial)
                                    <tr
...
text-center">
                                        ...
                                        <td class="px-6 py-2 text-center">
                                            {{ $complementBasedMaterial->nama_barang_sesuai_nota }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $complementBasedMaterial->jumlah_sus }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $complementBasedMaterial->satuan_ukur_sus }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $complementBasedMaterial->harga_satuan_sus }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $complementBasedMaterial->jumlah_ksu }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $complementBasedMaterial->satuan_ukur_ksu }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $complementBasedMaterial->total_nilai_si }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $complementBasedMaterial->satuan_ukur_si }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $complementBasedMaterial->harga_satuan_ukur_si }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $complementBasedMaterial->sub_total }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            <form
                                                action="{{ route('complement-based-materials.destroy', $complementBasedMaterial->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
...
dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">HAPUS</button>
                                            </form>
                                        </td>
                                    </tr>
                                @empty
                        ...
                        <div class="relative p-3">
                            {{ $complementBasedMaterials->links() }}
                        </div>
                    </div>
                </div>
            </div>
