                ...
                <div class="mx-auto grid w-full py-4 px-4 sm:px-6 lg:px-8 text-gray-900 dark:text-gray-100">
                    <div class="flex items-center justify-between py-5 mb-5">
                        ...
                        <div class="md:mt-0 sm:flex-none w-72">
                            <form action="{{ route('complement-based-notes.index') }}" method="GET">
...
dark:text-gray-300 dark:focus:border-indigo-700 dark:active:bg-gray-700 dark:active:text-gray-300" />
                        ...
                        <div class="sm:ml-16 sm:mt-0 sm:flex-none">
                            <a type="button" href="{{ route('complement-based-notes.create') }}"
...
dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <tbody>
                                @forelse($complementBasedNotes as $complementBasedNote)
                                    <tr
...
text-center">
                                        ...
                                        <td class="px-6 py-2 text-center">
                                            {{ $complementBasedNote->tanggal_nota }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $complementBasedNote->no_kwitansi }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $complementBasedNote->kode_supplier }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $complementBasedNote->nama_supplier }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $complementBasedNote->total_harga }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            <form
                                                action="{{ route('complement-based-notes.destroy', $complementBasedNote->id) }}"
                                                method="POST">
                                                <div class="flex">
                                                    @csrf
                                                    @method('DELETE')
