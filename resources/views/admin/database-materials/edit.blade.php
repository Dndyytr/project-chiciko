        ...
        <div class="mx-auto space-y-6">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-sm">
                <div class="mx-auto grid w-full py-4 px-4 sm:px-6 lg:px-8 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('database-materials.update', $databaseMaterial->id) }}"
                        x-data="DatabaseMaterialForm()">
                        @csrf
                        @method('PUT')
                        <!-- nama -->
                        <div>
                            ...
                            <x-text-input id="name" class="block mt-1 w-full" type="text" name="name"
                                :value="old('name', $databaseMaterial->name)" required autocomplete="username" />
                        ...
                        <div class="w-full grid grid-cols-2 gap-2 lg:gap-4">
                            ...
                            <div class="select-search">
                                ...
                                <input type="hidden" name="text_jp" id="text_jp"
                                    ...
                                    value="{{ old('text_jp', $databaseMaterial->text_jp) }}">
                            </div>
                            <!-- Kode JP -->
                            <div>
                                <x-input-label for="kode_jp" :value="__('kode JP')" />
                                <x-text-input id="kode_jp" class="block mt-1 w-full" type="text" name="kode_jp"
                                    x-model="$store.databaseMaterialForm.kodeJP" required :value="old('kode_jp', $databaseMaterial->kode_jp)"
                        ...
                        <div class="w-full grid grid-cols-2 gap-2 lg:gap-4">
                            ...
                            <div class="select-search">
                                ...
                                <input type="hidden" name="text_lvl1_jb" id="text_lvl1_jb"
                                    ...
                                    value="{{ old('text_lvl1_jb', $databaseMaterial->text_lvl1_jb) }}">
                            </div>
                            ...
                            <div class="select-search">
                                ...
                                <x-text-input id="kode_lvl1_jb" class="block mt-1 w-full" type="text"
                                    ...
                                    x-model="$store.databaseMaterialForm.kodeLvl1JB" :value="old('kode_lvl1_jb', $databaseMaterial->kode_lvl1_jb)" />
                        ...
                        <div class="w-full grid grid-cols-2 gap-2 lg:gap-4">
                            ...
                            <div class="select-search">
                                ...
                                <input type="hidden" name="text_lvl2_jb" id="text_lvl2_jb"
                                    ...
                                    value="{{ old('text_lvl2_jb', $databaseMaterial->text_lvl2_jb) }}">
                            </div>
                            ...
                            <div class="select-search">
                                ...
                                <x-text-input id="kode_lvl2_jb" class="block mt-1 w-full" type="text"
                                    ...
                                    x-model="$store.databaseMaterialForm.kodeLvl2JB" :value="old('kode_lvl2_jb', $databaseMaterial->kode_lvl2_jb)" />
                        ...
                        <div class="w-full grid grid-cols-2 gap-2 lg:gap-4">
                            ...
                            <div class="select-search">
                                ...
                                <input type="hidden" name="text_lvl3_jb" id="text_lvl3_jb"
                                    ...
                                    value="{{ old('text_lvl3_jb', $databaseMaterial->text_lvl3_jb) }}">
                            </div>
                            ...
                            <div class="select-search">
                                ...
                                <x-text-input id="kode_lvl3_jb" class="block mt-1 w-full" type="text"
                                    ...
                                    x-model="$store.databaseMaterialForm.kodeLvl3JB" :value="old('kode_lvl3_jb', $databaseMaterial->kode_lvl3_jb)" />
                        ...
                        <div class="w-full grid grid-cols-2 gap-2 lg:gap-4">
                            ...
                            <div class="select-search">
                                ...
                                <input type="hidden" name="text_warna" id="text_warna"
                                    ...
                                    value="{{ old('text_warna', $databaseMaterial->text_warna) }}">
                            </div>
                            <!-- Kode Warna -->
                            <div class="select-search">
                                ...
                                <x-text-input id="kode_warna" class="block mt-1 w-full" type="text"
                                    ...
                                    x-model="$store.databaseMaterialForm.kodeWarna" :value="old('kode_warna', $databaseMaterial->kode_warna)" />
                        ...
                        <div class="w-full grid grid-cols-2 gap-2 lg:gap-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="kode_bahan" class="block mt-1 w-full" type="text"
                                    ...
                                    x-model="$store.databaseMaterialForm.kodeBahan" :value="old('kode_bahan', $databaseMaterial->kode_bahan)" />
                                ...
                                <div class="flex items-center space-x-4 mt-2">
                                    <label class="flex items-center">
                                        <input type="radio" name="status" value="Aktif"
                                            {{ old('status', $databaseMaterial->status) == 'Aktif' ? 'checked' : '' }}
                                            class="text-indigo-600 focus:ring-indigo-500 border-gray-300">
                                        <span class="ml-2">Aktif</span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="radio" name="status" value="Non Aktif"
                                            {{ old('status', $databaseMaterial->status) == 'Non Aktif' ? 'checked' : '' }}
                                            class="text-indigo-600 focus:ring-indigo-500 border-gray-300">
...
<script>
    const editData = {
        text_jp: "{{ $databaseMaterial->text_jp }}",
        kode_jp: "{{ $databaseMaterial->kode_jp }}",
        text_lvl1_jb: "{{ $databaseMaterial->text_lvl1_jb }}",
        kode_lvl1_jb: "{{ $databaseMaterial->kode_lvl1_jb }}",
        text_lvl2_jb: "{{ $databaseMaterial->text_lvl2_jb }}",
        kode_lvl2_jb: "{{ $databaseMaterial->kode_lvl2_jb }}",
        text_lvl3_jb: "{{ $databaseMaterial->text_lvl3_jb }}",
        kode_lvl3_jb: "{{ $databaseMaterial->kode_lvl3_jb }}",
        text_warna: "{{ $databaseMaterial->text_warna }}",
        kode_warna: "{{ $databaseMaterial->kode_warna }}",
    };
    ...
    document.addEventListener('alpine:init', () => {
        Alpine.store('databaseMaterialForm', {
            // Jenis Persediaan
            idTextJP: '',
            textJP: editData.text_jp,
            kodeJP: editData.kode_jp,

            // Level 1 Jenis Bahan
            idTextLvl1JB: '',
            textLvl1JB: editData.text_lvl1_jb,
            kodeLvl1JB: editData.kode_lvl1_jb,

            // Level 2 Jenis Bahan
            idTextLvl2JB: '',
            textLvl2JB: editData.text_lvl2_jb,
            kodeLvl2JB: editData.kode_lvl2_jb,

            // Level 3 Jenis Bahan
            idTextLvl3JB: '',
            textLvl3JB: editData.text_lvl3_jb,
            kodeLvl3JB: editData.kode_lvl3_jb,

            // Warna
            idTextWarna: '',
            textWarna: editData.text_warna,
            kodeWarna: editData.kode_warna,
    ...
    function findIDsFromTexts() {
        ...
        // Find ID untuk Text JP
        const jpItem = window.dropdownData.listAccountingEstimates.find(item =>
            item.nama === editData.text_jp && item.kode === editData.kode_jp
        );
        if (jpItem) {
            store.idTextJP = jpItem.value;
        }

        // Find ID untuk Level 1
        const lvl1Item = window.dropdownData.lvl1TypeMaterials.find(item =>
            item.nama === editData.text_lvl1_jb && item.kode === editData.kode_lvl1_jb
        );
        if (lvl1Item) {
            store.idTextLvl1JB = lvl1Item.value;
        }

        // Find ID untuk Level 2
        const lvl2Item = window.dropdownData.lvl2TypeMaterials.find(item =>
            item.nama === editData.text_lvl2_jb && item.kode === editData.kode_lvl2_jb
        );
        if (lvl2Item) {
            store.idTextLvl2JB = lvl2Item.value;
        }

        // Find ID untuk Level 3
        const lvl3Item = window.dropdownData.lvl3TypeMaterials.find(item =>
            item.nama === editData.text_lvl3_jb && item.kode === editData.kode_lvl3_jb
        );
        if (lvl3Item) {
            store.idTextLvl3JB = lvl3Item.value;
        }

        // Find ID untuk Warna
        const warnaItem = window.dropdownData.listColorEstimates.find(item =>
            item.warna === editData.text_warna && item.kode === editData.kode_warna
        );
        if (warnaItem) {
            store.idTextWarna = warnaItem.value;
        }
    }
    ...
    function setInitialValuesFromInline() {
        ...
        const configs = [{
                id: 'id_text_jp',
                value: store.idTextJP
            },
            {
                id: 'id_text_lvl1_jb',
                value: store.idTextLvl1JB
            },
            {
                id: 'id_text_lvl2_jb',
                value: store.idTextLvl2JB
            },
            {
                id: 'id_text_lvl3_jb',
                value: store.idTextLvl3JB
            },
            {
                id: 'id_text_warna',
                value: store.idTextWarna
            }
        ];
