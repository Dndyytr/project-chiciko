        ...
        <div class="mx-auto space-y-6">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-sm">
                <div class="mx-auto grid w-full py-4 px-4 sm:px-6 lg:px-8 text-gray-900 dark:text-gray-100">
                    <form method="POST"
                        action="{{ route('worksheet-abbreviations.update', $worksheetAbbreviation->id) }}">
                        @csrf
                        @method('PUT')
                        <!-- Singkatan -->
                        <div>
                            ...
                            <x-text-input id="singkatan" class="block mt-1 w-full" type="text" name="singkatan"
                                :value="old('singkatan', $worksheetAbbreviation->singkatan)" autofocus required />
                        ...
                        <div>
                            ...
                            <x-text-input id="lengkap" class="block mt-1 w-full" type="text" name="lengkap"
                                :value="old('lengkap', $worksheetAbbreviation->lengkap)" autofocus required />
