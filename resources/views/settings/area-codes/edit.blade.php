        ...
        <div class="mx-auto space-y-6">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-sm">
                <div class="mx-auto grid w-full py-4 px-4 sm:px-6 lg:px-8 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('area-codes.update', $areaCode->id) }}">
                        @csrf
                        @method('PUT')
                        <!-- Nama Daerah -->
                        <div>
                            <x-input-label for="nama_daerah" :value="__('Nama Daerah')" />
                            <x-text-input id="nama_daerah" class="block mt-1 w-full" type="text" name="nama_daerah"
                                :value="old('nama_daerah', $areaCode->nama_daerah)" autofocus required />
                        ...
                        <div>
                            ...
                            <x-text-input id="kode" class="block mt-1 w-full" type="text" name="kode"
                                :value="old('kode', $areaCode->kode)" required />
