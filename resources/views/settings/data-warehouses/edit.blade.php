        ...
        <div class="mx-auto space-y-6">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-sm">
                <div class="mx-auto grid w-full py-4 px-4 sm:px-6 lg:px-8 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('data-warehouses.update', $dataWarehouse->id) }}">
                        @csrf
                        @method('PUT')
                        <!-- Nama Gudang -->
                        <div>
                            ...
                            <x-text-input id="nama_gudang" class="block mt-1 w-full" type="text" name="nama_gudang"
                                :value="old('nama_gudang', $dataWarehouse->nama_gudang)" autofocus required />
                        ...
                        <div>
                            ...
                            <textarea name="lokasi" id="lokasi" rows="3"
                                ...
                                required>{{ old('lokasi', $dataWarehouse->lokasi) }}</textarea>
