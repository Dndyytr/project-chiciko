        ...
        <div class="mx-auto space-y-6">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-sm">
                <div class="mx-auto grid w-full py-4 px-4 sm:px-6 lg:px-8 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('coordinator-codes.update', $coordinatorCode->id) }}">
                        @csrf
                        @method('PUT')
                        <!-- Nama Koordinator -->
                        <div>
                            <x-input-label for="nama_koordinator" :value="__('Nama Koordinator')" />
                            <x-text-input id="nama_koordinator" class="block mt-1 w-full" type="text"
                                name="nama_koordinator" :value="old('nama_koordinator', $coordinatorCode->nama_koordinator)" autofocus required />
                        ...
                        <div>
                            ...
                            <x-text-input id="kode" class="block mt-1 w-full" type="text" name="kode"
                                :value="old('kode', $coordinatorCode->kode)" required />
                        ...
                        <div class="flex items-center justify-end mt-6">
                            <a href="{{ route('coordinator-codes.index') }}"
