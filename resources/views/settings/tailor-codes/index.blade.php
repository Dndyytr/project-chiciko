                ...
                <div class="mx-auto grid w-full py-4 px-4 sm:px-6 lg:px-8 text-gray-900 dark:text-gray-100">
                    <div class="flex items-center justify-between py-5 mb-5">
                        ...
                        <div class="md:mt-0 sm:flex-none w-72">
                            <form action="{{ route('tailor-codes.index') }}" method="GET">
...
dark:text-gray-300 dark:focus:border-indigo-700 dark:active:bg-gray-700 dark:active:text-gray-300" />
                        ...
                        <div class="sm:ml-16 sm:mt-0 sm:flex-none">
                            <a type="button" href="{{ route('tailor-codes.create') }}"
...
dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <tbody>
                                @forelse($tailorCodes as $tailorCode)
                                    <tr
...
text-center">
                                        ...
                                        <td class="px-6 py-2 text-center">
                                            {{ $tailorCode->nama_koordinator }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $tailorCode->kode_koordinator }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $tailorCode->nama_daerah }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $tailorCode->kode_daerah }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $tailorCode->nama_penjahit }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $tailorCode->no_urut }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $tailorCode->kode_penjahit }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            <form action="{{ route('tailor-codes.destroy', $tailorCode->id) }}"
                                                method="POST">
                                                <div class="flex">
                                                    <a href="{{ route('tailor-codes.edit', $tailorCode->id) }}"
