        ...
        <div class="mx-auto space-y-6">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-sm">
                <div class="mx-auto grid w-full py-4 px-4 sm:px-6 lg:px-8 text-gray-900 dark:text-gray-100">
                    <form method="POST"
                        action="{{ route('list-supplier-estimates.update', $listSupplierEstimate->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="grid grid-cols-2 gap-3">
                            ...
                            <div>
                                ...
                                <x-text-input id="inisial" class="block mt-1 w-full" type="text" name="inisial"
                                    :value="old('inisial', $listSupplierEstimate->inisial)" autofocus required />
                            ...
                            <div>
                                ...
                                <x-text-input id="nama_supplier" class="block mt-1 w-full" type="text"
                                    name="nama_supplier" :value="old('nama_supplier', $listSupplierEstimate->nama_supplier)" required />
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            ...
                            <div>
                                ...
                                <x-text-input id="kontak" class="block mt-1 w-full" type="text" name="kontak"
                                    :value="old('kontak', $listSupplierEstimate->kontak)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="rekening" class="block mt-1 w-full" type="text" name="rekening"
                                    :value="old('rekening', $listSupplierEstimate->rekening)" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="kode" class="block mt-1 w-full" type="text" name="kode"
                                :value="old('kode', $listSupplierEstimate->kode)" required />
                        ...
                        <div>
                            ...
                            <textarea name="alamat" id="alamat"
                                ...
                                rows="5" cols="50" required>{{ old('alamat', $listSupplierEstimate->alamat) }}</textarea>
