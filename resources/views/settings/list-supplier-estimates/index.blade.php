                ...
                <div class="mx-auto grid w-full py-4 px-4 sm:px-6 lg:px-8 text-gray-900 dark:text-gray-100">
                    <div class="flex items-center justify-between py-5 mb-5">
                        ...
                        <div class="md:mt-0 sm:flex-none w-72">
                            <form action="{{ route('list-supplier-estimates.index') }}" method="GET">
...
dark:text-gray-300 dark:focus:border-indigo-700 dark:active:bg-gray-700 dark:active:text-gray-300" />
                        ...
                        <div class="sm:ml-16 sm:mt-0 sm:flex-none">
                            <a type="button" href="{{ route('list-supplier-estimates.create') }}"
...
dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <tbody>
                                @php $i = $i ?? 0; @endphp
                                @forelse($listSupplierEstimates as $listSupplierEstimate)
                                    <tr
...
dark:text-white text-center">
                                        ...
                                        <td class="px-6 py-2 text-center">
                                            {{ $listSupplierEstimate->inisial }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $listSupplierEstimate->nama_supplier }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $listSupplierEstimate->alamat }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $listSupplierEstimate->kontak }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $listSupplierEstimate->rekening }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            {{ $listSupplierEstimate->kode }}
                                        </td>
                                        <td class="px-6 py-2 text-center">
                                            <form
                                                action="{{ route('list-supplier-estimates.destroy', $listSupplierEstimate->id) }}"
                                                method="POST">
                                                <a href="{{ route('list-supplier-estimates.edit', $listSupplierEstimate->id) }}"
